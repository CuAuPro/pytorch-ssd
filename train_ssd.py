...
from vision.utils.misc import EarlyStopping
...
if __name__ == '__main__':
    ...
    val_transform = TestTransform(config.image_size, config.image_mean, config.image_std)
    ...
    if args.dataset_type == "voc":
        val_dataset = VOCDataset(dataset_path, transform=val_transform,
    ...
    early_stopping = EarlyStopping(patience=10, verbose=True, path=args.checkpoint_folder+"model.pth", trace_func=logging.info)
